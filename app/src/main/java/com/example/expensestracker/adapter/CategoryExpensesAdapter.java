...
public class CategoryExpensesAdapter extends RecyclerView.Adapter<CategoryExpensesAdapter.MyViewHolder> {
    ...
    private DatabaseReference refCat = db.getReference().child("user").child(uid).child("categories").child("expenses");

    public CategoryExpensesAdapter(Context context, ArrayList<Category> data) {
    ...
    @NonNull
    @Override
    public CategoryExpensesAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull CategoryExpensesAdapter.MyViewHolder holder, int position) {
